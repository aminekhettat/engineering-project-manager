...
def main():
    parser = argparse.ArgumentParser(description="Validate the installed skill and optional local smoke projects")
    ...
    required_scripts = [
        ...
        "domain_audit.py",
        "project_state.py",
        "project_manager_self_check.py",
        "change_manager.py",
        "baseline_manager.py",
        "configuration_audit.py",
        "verification_evidence.py",
        "verification_evidence_audit.py",
        "verification_evidence_tests.py",
        "migration_assess.py",
        "migration_compat_tests.py",
        "skill_package_check.py",
        "release_fixture_test.py",
        "requirements_compatibility_tests.py",
        "domain_audit_tests.py",
        "project_state_tests.py",
    ]
    ...
    package_check = run([
        sys.executable,
        str(SCRIPTS / "skill_package_check.py"),
        str(PM),
    ])
    ...
    release_fixture = run([
        sys.executable,
        str(SCRIPTS / "release_fixture_test.py"),
    ])
    ...
    requirement_compatibility = run([
        sys.executable,
        str(SCRIPTS / "requirements_compatibility_tests.py"),
    ])
    ...
    domain_behavior = run([
        sys.executable,
        str(SCRIPTS / "domain_audit_tests.py"),
    ])
    ...
    task_behavior = run([
        sys.executable,
        str(SCRIPTS / "project_state_tests.py"),
    ])
    ...
    evidence_behavior = run([
        sys.executable,
        str(SCRIPTS / "verification_evidence_tests.py"),
    ])
    ...
    check_file(
        SCRIPTS / "migration_compat_tests.py",
    ...
    migration_tests = run([
        sys.executable,
        str(SCRIPTS / "migration_compat_tests.py"),
    ])
