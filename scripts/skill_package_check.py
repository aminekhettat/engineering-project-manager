...
def main() -> int:
    ...
    parser.add_argument("skill", nargs="?", default=Path(__file__).resolve().parent.parent)
    ...
    required_resources = {
        ...
        "scripts/export_public_skill.py",
        ...
        "scripts/project_manager_self_check.py",
        "scripts/change_baseline_tests.py",
        "scripts/requirements_compatibility_tests.py",
        "scripts/domain_audit_tests.py",
        "scripts/project_state_tests.py",
    }
